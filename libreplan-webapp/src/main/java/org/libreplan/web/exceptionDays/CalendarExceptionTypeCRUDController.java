...
public class CalendarExceptionTypeCRUDController extends BaseCRUDController<CalendarExceptionType> {
    ...
    public void doAfterCompose(Component comp) throws Exception {
        ...
        // controller.exceptionDayType, which is still null at this point (only set up by
     ...
     */
    public boolean isExceptionDayTypeCodeAutogenerated() {
        return getExceptionDayType().isCodeAutogenerated();
    }

    public void setExceptionDayTypeCodeAutogenerated(boolean codeAutogenerated) {
        getExceptionDayType().setCodeAutogenerated(codeAutogenerated);
    }
    ...
    public List<CalendarExceptionType> getExceptionDayTypes() {
        ...
        return new org.zkoss.zul.ListModelList<>(calendarExceptionTypeModel.getExceptionDayTypes());
    }
    ...
    public org.zkoss.zul.ListModel getColors() {
        // The listbox's "model" property is declared as org.zkoss.zul.ListModel - AnnotateBinder
        // has no automatic array->ListModel coercion, so returning a plain array here throws a
        // ClassCastException when the binder tries to load it.
        return new org.zkoss.zul.ListModelArray<>(CalendarExceptionTypeColor.values());
    }
