...
public class ProjectDetailsController extends GenericForwardComposer<Component> {
    ...
    private void showWrongValue() {
        throw new WrongValueException(initDate, _t("cannot be empty"));
    }

    private void showWrongName() {
        throw new WrongValueException(txtName, _t("project name already being used"));
    }
    ...
    public void setTemplate(OrderTemplate template) {
        ...
        if (template == null) {
            ...
            generateCode.setTooltiptext(_t("Set Code as autogenerated to create a new project from templates"));
