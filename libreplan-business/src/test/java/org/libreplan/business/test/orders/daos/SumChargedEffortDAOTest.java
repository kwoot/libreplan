...
public class SumChargedEffortDAOTest {
    ...
    public void testFindByOrderElementReturnsNullWhenAbsent() {
        ...
        assertNull(sumChargedEffortDAO.findByOrderElement(orderLine));
    }
    ...
    public void testFindByOrderElementReturnsMatch() {
        OrderLine orderLine = createValidOrderElement();
        SumChargedEffort sumChargedEffort = SumChargedEffort.create(orderLine);
        sumChargedEffortDAO.save(sumChargedEffort);

        SumChargedEffort found = sumChargedEffortDAO.findByOrderElement(orderLine);
        assertEquals(sumChargedEffort.getId(), found.getId());
    }
    ...
    public void testFindByOrderElementDoesNotConfuseDifferentOrderElements() {
        ...
        SumChargedEffort sumChargedEffort = SumChargedEffort.create(orderLine1);
        sumChargedEffortDAO.save(sumChargedEffort);

        assertNull(sumChargedEffortDAO.findByOrderElement(orderLine2));
    }
